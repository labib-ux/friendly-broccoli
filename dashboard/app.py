...
def main() -> None:
    ...
    # SECTION 2 — Fetch all data from database
    ...
    # SECTION 3 — Top-level metrics row
    st.divider()
    ...
    with ctrl_col1:
        if st.button(
            ...
            help="Writes paused=true to bot_control.json. "
            ...
            try:
                ...
                st.warning(
                    f"Could not write to {CONTROL_FILE}: {e}. "
    ...
    if not trades:
        ...
        # SECTION 6 — Build trade DataFrame and cumulative PnL chart
        ...
        # SECTION 7 — Individual trade PnL bar chart
        sell_trades = df[
            df['pnl'].notna() & (df['side'] == 'sell')
        ].copy()
    ...
    # SECTION 9 — Auto-refresh control
    st.divider()
    ...
    with refresh_col1:
        auto_refresh = st.checkbox(
            ...
            value=True,
            help="Automatically polls the database and rerenders "
